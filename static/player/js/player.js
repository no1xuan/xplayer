...
var key = $("#music")
	.attr("key"); //key密钥
consolelog('XPlayer v' + XPLAYER_VERSION + ' BY:Ocink', api);
$("head")
	.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"/static/player/css/player.css\">");
...
$cover.html("<img src='https://q1.qlogo.cn/g?b=qq&nk=2687409344&s=140'>");
playList = {
	creat: {
		album: function() {
...
function netmusic() {
	...
	d.onerror = function() {
		d.src = "https://q1.qlogo.cn/g?b=qq&nk=24677102&s=140";
		$(".cover", $player)
			.html("<img src='" + d.src + "'>");
		setTimeout(function() {
			Tips.show("专辑图片获取失败")
